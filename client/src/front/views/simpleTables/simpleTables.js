      ...
      <AnimatedView>
        <div className="row">
          <div className="col-md-6">
            <div className="panel">
              <header className="panel-heading">Bordered Table</header>
          ...
          <div className="col-md-6">
            <div className="panel">
              <header className="panel-heading">Simple Full Width Table</header>
              <div className="panel-body">
